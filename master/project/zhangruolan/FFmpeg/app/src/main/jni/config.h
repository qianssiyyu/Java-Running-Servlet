...
#define FFMPEG_CONFIGURATION "--enable-memalign-hack --disable-static --enable-shared --enable-small --enable-sse --enable-ssse3 --enable-mmx --enable-pthreads"
...
#define CC_IDENT "gcc 3.4.5 (GCC) (mingw-vista special 3)"
