...
<script type="text/html" id="imgtmp">
	<img src="http://34.92.146.242:8080/rapstar/user/{{d.photoPath}}" class="layui-nav-img" style="width:30px;height:30px">
</script>
<script>
layui.use(['form','table'], function(){
	    ...
	    cols: [[
	    	...
	    	,{field: 'photoPath', title: '头像', width:80,templet:"#imgtmp"}
	    	,{field: 'intro', title: 'intro', width:80}
	    	,{field: 'stars', title: '粉丝', width:80}
	    	,{field: 'followers', title: '关注', width:80}
	        ,{field: 'isVip', title: '级别', width:80}
	        ,{field: 'certification', title: '身份', width:80}
      ...
      //编辑
    	...
    	layer.open({
            ...
            success : function(layero, index) { // 成功弹出后回调
                layer.iframeAuto(index);
                 var body = layer.getChildFrame('body', index);  //巧妙的地方在这里哦
                    ...
                    body.contents().find("#usex").val(data.sex);
            ...
            yes : function(index, layero) { // 保存按钮回调函数
                ...
                var sex = body.contents().find("#usex").val();
