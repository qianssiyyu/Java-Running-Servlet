...
<form class="layui-form" action="">
  <div class="layui-inline" style="margin-top:15px">
          ...
          <div class="layui-inline" style="margin-top:15px">
            <label class="layui-form-label">demo名</label>
            <div class="layui-input-block">
